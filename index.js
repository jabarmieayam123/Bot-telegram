...
// Configuration
const apikey = 'ptlc_HNwseuxDV5NYlDsDM08jPaKKVIpwn546rlRExcOOpi0';
const capikey = 'ptla_6aeCoAVlLRGr6g75yP9qjO4gtEdWDgeFx5KyoPB09mY';
const domain = 'https://farzslebeww.xyro.web.id';
const nestid = '5';
const egg = '15';
const loc = '1';
const gmailadmin = 'admin@gmail.com'; // Admin email that won't be deleted
const telegramBotToken = '8462125785:AAGZqZPZIHG7T2ounH_BDUPiRO75J2DmDmA';
const adminTelegramId = '7275726524;
